...
import 'package:home_workout/Screens/workout/workout_rest.dart';
...
class ArmBiginnerScreen extends StatelessWidget {
  const ArmBiginnerScreen({Key? key}) : super(key: key);
              ...
              child: SizedBox(
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final List<QueryDocumentSnapshot> filteredDataList = dataList.where((doc) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final Map<String, dynamic> map = filteredDataList[index].data() as Map<String, dynamic>;
        ...
        child: ElevatedButton(
          onPressed: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (ctx) => WorkoutRestScreen(filteredDataList: filteredDataListNew),
              ),
            );
          },
          style: ButtonStyle(
